    ...
    <>
      ...
      <Billboard>
        <Text font="/DancingScript-VariableFont_wght.ttf" maxWidth={4.5} textAlign="center" position={[0, 12.45, 0]} fontSize="0.35" lineHeight={0.85}>
          May this Christmas season sparkle with moments of joy, laughter and goodwill. {'\n\n'}Wishing you and your family a Christmas filled with laughter, love, and cozy moments. May your holiday season be as magical as you are!
        </Text>
